...
class ExceptionFormatter:
    ...
    def format_exception(self, exc_info: Optional[Tuple[type, BaseException, Any]] = None) -> str:
    ...
    def _get_context_lines(self, filename: str, lineno: int) -> List[Tuple[int, str, bool]]:
    ...
    def _format_frame_variables(self, frame: Any) -> List[str]:
        ...
        try:
            ...
            filtered_vars = {
                k: v for k, v in local_vars.items() if not k.startswith("__") and not callable(v)
            }
